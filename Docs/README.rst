...
:Contact:
:Date:
:Web site: docutils.sourceforge.io
...
* Since version 0.21, Docutils requires PythonÂ 3.9 or later.
* Docutils versions 0.19 to 0.20.1 require PythonÂ 3.7 or later.
* Docutils versions 0.16 to 0.18 require PythonÂ 2.7 or 3.5+.

The **type hints** added in version 0.22 use PythonÂ 3.10 syntax.
...
.. _sandbox: https://docutils.sourceforge.io/sandbox/README.html#README.rst/
...
shell commands will generate HTML for all included documentation::
    ...
    tools/build.html.pyx .

On Windows systems, type::

    cd <archive_directory_path>
    py tools\build.html.pyx ..
